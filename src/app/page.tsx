  ...
  return (
    <main className="flex min-h-screen flex-col">
      <ScrollAnimation animation="fadeIn">
        <section id="hero" className="bg-primary-600 dark:bg-primary-800 text-white py-16 px-4 text-center">
          <div className="container mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Viva Dentistry</h1>
      ...
      <ScrollAnimation animation="slideUp">
        <section id="services" className="py-20 px-4 bg-white dark:bg-secondary-900">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 dark:text-white">Our Services</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <ScrollAnimation animation="slideRight" delay={0.1}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    <div className="w-16 h-16 bg-primary-100 dark:bg-primary-900/50 rounded-full flex items-center justify-center mb-4 text-primary-600 dark:text-primary-400 group-hover:bg-primary-600 group-hover:text-white dark:group-hover:bg-primary-500 transition-all duration-300">
                      <FaTooth className="w-8 h-8" />
                    </div>
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">General Dentistry</h3>
              ...
              <ScrollAnimation animation="slideUp" delay={0.2}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">Cosmetic Dentistry</h3>
              ...
              <ScrollAnimation animation="slideLeft" delay={0.3}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">Dental Implants</h3>
              ...
              <ScrollAnimation animation="slideRight" delay={0.4}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">Clear Aligners</h3>
              ...
              <ScrollAnimation animation="slideUp" delay={0.5}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">FastBraces</h3>
              ...
              <ScrollAnimation animation="slideLeft" delay={0.6}>
                <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold mb-3 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400 transition-colors">Emergency Dental Care</h3>
      ...
      <ScrollAnimation animation="fadeIn">
        <section id="about" className="py-16 px-4 bg-gray-100 dark:bg-secondary-800">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8 dark:text-white">About Us</h2>
      ...
      <ScrollAnimation animation="slideUp">
        <section id="contact" className="py-16 px-4 bg-primary-600 dark:bg-primary-800 text-white">
          <div className="container mx-auto">
              ...
              <ScrollAnimation animation="slideRight">
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="mb-2"><strong>Email:</strong> info@vivadentistry.com</p>
                ...
                <div className="card bg-white dark:bg-secondary-800 text-secondary-800 dark:text-white p-6 rounded-lg shadow-lg">
                  ...
                  <form>
                    <div className="mb-4">
                      ...
                      <input type="text" id="name" className="input w-full bg-white dark:bg-secondary-700 text-secondary-800 dark:text-white border-secondary-300 dark:border-secondary-600" placeholder="Your name" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="email" className="block mb-2 font-medium">Email</label>
                      <input type="email" id="email" className="input w-full bg-white dark:bg-secondary-700 text-secondary-800 dark:text-white border-secondary-300 dark:border-secondary-600" placeholder="Your email" />
                    </div>
                    <div className="mb-4">
                      <label htmlFor="phone" className="block mb-2 font-medium">Phone</label>
                      <input type="tel" id="phone" className="input w-full bg-white dark:bg-secondary-700 text-secondary-800 dark:text-white border-secondary-300 dark:border-secondary-600" placeholder="Your phone number" />
                    </div>
                    <div className="mb-4">
